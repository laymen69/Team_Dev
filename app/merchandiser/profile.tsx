...
export default function Profile() {
  ...
  const [merchStats, setMerchStats] = useState<MerchandiserStats | null>(null);
  ...
  const fetchStats = async () => {
    const stats = await StatsService.getMerchandiserStats();
    if (stats) setMerchStats(stats);
  };
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statsRow}>
            <View style={[styles.statCardGlass, { backgroundColor: colors.surface + '60', borderColor: colors.border }]}>
               ...
               <View style={{ flex: 1 }}>
                   <Text style={[styles.statValue, { color: colors.text }]}>{merchStats?.reports_done || '—'}</Text>
            ...
            <View style={[styles.statCardGlass, { backgroundColor: colors.surface + '60', borderColor: colors.border }]}>
               ...
               <View style={{ flex: 1 }}>
                   <Text style={[styles.statValue, { color: colors.text }]}>{merchStats?.target_hit || '—'}</Text>
                   <Text style={[styles.statLabel, { color: colors.textMuted }]}>Target Score</Text>
               </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={[styles.footerText, { color: colors.textMuted }]}>FieldForce Merchandiser v1.2.0</Text>
        </View>
      </ScrollView>
